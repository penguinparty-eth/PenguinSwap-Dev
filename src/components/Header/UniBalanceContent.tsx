        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            ...
            {uni && uni.chainId === ChainId.MAINNET ? (
              <AnalyticsLink href={`https://penguinalytics.eth.link/#/token/${uni.address}`}>View 🐟 Analytics</AnalyticsLink>
            ) : null}
            {shrimp && shrimp.chainId === ChainId.MAINNET ? (
              <AnalyticsLink href={`https://penguinalytics.eth.link/#/token/${shrimp.address}`}>View 🦐 Analytics</AnalyticsLink>
            ) : null}
            {crab && crab.chainId === ChainId.MAINNET ? (
              <AnalyticsLink href={`https://penguinalytics.eth.link/#/token/${crab.address}`}>View 🦀 Analytics</AnalyticsLink>
            ) : null}
            {tori && tori.chainId === ChainId.MAINNET ? (
              <AnalyticsLink href={`https://penguinalytics.eth.link/#/token/${tori.address}`}>View ⛩ Analytics</AnalyticsLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
